...
I would use *Sublime* to write Chinese and blogs, and *Vim* ([commands](https://franklinqin0.me/Vim-commands) and [cutomizations](https://franklinqin0.me/Vim-customize)) to code.
